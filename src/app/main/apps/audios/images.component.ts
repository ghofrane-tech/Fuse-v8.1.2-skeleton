...
export class ImagesComponent implements OnInit {
    ...
    ngOnInit() {
        this.http.get(`http://localhost:4000/audios`).subscribe(
        //     (res) => {
        //         console.log(res);
        //         this.list = res;
        //     },
    ...
    delete(id) {
        console.log(id);
        this.http.delete(`http://localhost:4000/audios/` + id).subscribe(
            (res) => {
                console.log(res);
    ...
    add(audio) {
        console.log(audio);
        this.http
            .post(`http://localhost:4000/audio/favorit`, { audio})
            .subscribe(
                (res) => {
                    console.log(res);
                },
